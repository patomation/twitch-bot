...
export const keywords: Commands = {
  ...
  python: {
    text: [
      'python is ok. Whats up with all the tabs. Where did the brackets go?',
      'python is that a snek?'
    ]
  },
  javascript: {
    text: [
      'Is that the same as java',
      'I like coffee and scrolls',
  ...
  LUL: {
    say: 'ha ha ha he he he ho ho ho',
    text: 'LUL LUL LUL LUL LUL LUL LUL'
  },
  coffee: {
